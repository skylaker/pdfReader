...
public class TypewriterToolHandler implements ToolHandler {
    ...
    public void onActivate() {
        ...
        mCreateAlive = true;
        mIsCreated = false;
        AppKeyboardUtil.setKeyboardListener(((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).getRootView(), ((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).getRootView(), new AppKeyboardUtil.IKeyboardListener() {
            @Override
    ...
    public void onDeactivate() {
        ...
        AppKeyboardUtil.removeKeyboardListener(((UIExtensionsManager)mPdfViewCtrl.getUIExtensionsManager()).getRootView());
        mCreateAlive = true;
    }
    ...
    private void createFTAnnot() {
        if (mAnnotText != null && mAnnotText.length() > 0) {
            ...
            try {
                ...
                undoItem.mFont = mTextUtil.getSupportFont(mFont);
