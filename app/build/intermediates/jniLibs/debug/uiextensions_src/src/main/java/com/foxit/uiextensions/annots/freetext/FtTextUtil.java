...
public class FtTextUtil {
    ...
    private void initFontNameMap() {
        try {
            ...
            Font Courier = Font.createStandard(Font.e_fontStandardIDCourier);
            mFontNameMap.put(Courier.getName(), "Courier");
            Courier.release();
            Font Helvetica = Font.createStandard(Font.e_fontStandardIDHelvetica);
            mFontNameMap.put(Helvetica.getName(), "Helvetica");
            Helvetica.release();
            Font Times = Font.createStandard(Font.e_fontStandardIDTimes);
    ...
    public Font getSupportFont(String name) {
        ...
        try {
            if (name == null) {
                font = Font.createStandard(Font.e_fontStandardIDCourier);
            } else if (name.equals("Courier")) {
                font = Font.createStandard(Font.e_fontStandardIDCourier);
            } else if (name.equals("Helvetica")) {
                font = Font.createStandard(Font.e_fontStandardIDHelvetica);
            } else if (name.equals("Times")) {
                font = Font.createStandard(Font.e_fontStandardIDTimes);
