    ...
    private void initView() {
        ...
        for (int i = 0; i < mMenuItems.size(); i++) {
            ...
            if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_COPY) {
                ...
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getResources().getString(R.string.fx_string_strikeout));
            ...
            }else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_SIGNATURE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getResources().getString(R.string.rd_am_item_add_sign));
            ...
            } else if (mMenuItems.get(i).intValue() == AnnotMenu.AM_BT_VERIFY_SIGNATURE) {
                addSubMenu(mMenuItems.get(i).intValue(), mContext.getResources().getString(R.string.rv_security_dsg_verify));
            }
        }
        ...
        if (mMenuItems.size() > 0) {
            ...
            if (mShowing) {
                ...
                if (isShowing()) {
                    ...
                    if (RectF.intersects(rectF, screenRectF)) {
