    ...
    public void onColorValueChanged(int color) {
        ...
        try {
            if (annot != null && ToolUtil.getCurrentAnnotHandler(uiExtensionsManager) == this && color != annot.getBorderColor()) {
                modifyAnnot(annot.getPage().getIndex(), annot, annot.getRect(), color, (int) (((Square) annot).getOpacity() * 255f), annot.getBorderInfo().getWidth(), annot.getContent(), false, false, null);
            }
    ...
    public void onAnnotDeselected(Annot annot, boolean needInvalid) {
        ...
        try {
            ...
            if (needInvalid && mIsModify) {
                ...
                if (mTempLastColor == (int) annot.getBorderColor() && mTempLastLineWidth == annot.getBorderInfo().getWidth() && mTempLastBBox.equals(annot.getRect()) && mTempLastOpacity == (int) (((Square) annot).getOpacity() * 255f)) {
                    modifyAnnot(page.getIndex(), annot, annot.getRect(), (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255f), annot.getBorderInfo().getWidth(), annot.getContent(), false, false, null);
                } else {
                    modifyAnnot(page.getIndex(), annot, annot.getRect(), (int) annot.getBorderColor(), (int) (((Square) annot).getOpacity() * 255f), annot.getBorderInfo().getWidth(), annot.getContent(), true, true, null);
                }
            } else if (mIsModify) {
